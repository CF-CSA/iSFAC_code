...
${OBJECTDIR}/Parser.o: Parser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags gsl` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parser.o Parser.cpp

${OBJECTDIR}/Usage.o: Usage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags gsl` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Usage.o Usage.cpp
...
${OBJECTDIR}/kabsch.o: kabsch.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags gsl` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kabsch.o kabsch.cpp
